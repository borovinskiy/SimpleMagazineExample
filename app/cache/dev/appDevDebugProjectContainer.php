...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'prognoz_magazine.product_service' => 'getPrognozMagazine_ProductServiceService',
            'prognoz_magazine.user_service' => 'getPrognozMagazine_UserServiceService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/ars/NetBeansProjects/Shop/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/ars/NetBeansProjects/Shop/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/ars/NetBeansProjects/Shop/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/ars/NetBeansProjects/Shop/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'magazine', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'magazine', 'password' => 't4ograf8z7toi75y485oq758ao4', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_99834643bfd62e12d0f8a3e06d7a09f9');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_99834643bfd62e12d0f8a3e06d7a09f9');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_99834643bfd62e12d0f8a3e06d7a09f9');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home/ars/NetBeansProjects/Shop/src/Prognoz/MagazineBundle/Entity')), 'Prognoz\\MagazineBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('PrognozMagazineBundle' => 'Prognoz\\MagazineBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/home/ars/NetBeansProjects/Shop/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/ars/NetBeansProjects/Shop/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '5ec240321da65c3ae385a7f6844b3a6e54796912');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/ars/NetBeansProjects/Shop/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/ars/NetBeansProjects/Shop/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    /**
     * Gets the 'prognoz_magazine.product_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Prognoz\MagazineBundle\Services\ProductService A Prognoz\MagazineBundle\Services\ProductService instance.
     */
    protected function getPrognozMagazine_ProductServiceService()
    {
        return $this->services['prognoz_magazine.product_service'] = new \Prognoz\MagazineBundle\Services\ProductService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'prognoz_magazine.user_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Prognoz\MagazineBundle\Services\UserService A Prognoz\MagazineBundle\Services\UserService instance.
     */
    protected function getPrognozMagazine_UserServiceService()
    {
        return $this->services['prognoz_magazine.user_service'] = new \Prognoz\MagazineBundle\Services\UserService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/ars/NetBeansProjects/Shop/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/ars/NetBeansProjects/Shop/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/ars/NetBeansProjects/Shop/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/ars/NetBeansProjects/Shop/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/ars/NetBeansProjects/Shop/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/ars/NetBeansProjects/Shop/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/ars/NetBeansProjects/Shop/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/ars/NetBeansProjects/Shop/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/ars/NetBeansProjects/Shop/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/ars/NetBeansProjects/Shop/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/ars/NetBeansProjects/Shop/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/ars/NetBeansProjects/Shop/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/ars/NetBeansProjects/Shop/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/ars/NetBeansProjects/Shop/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/ars/NetBeansProjects/Shop/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/ars/NetBeansProjects/Shop/src/Prognoz/MagazineBundle/Resources/views', 'PrognozMagazine');
        $instance->addPath('/home/ars/NetBeansProjects/Shop/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/home/ars/NetBeansProjects/Shop/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/ars/NetBeansProjects/Shop/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/ars/NetBeansProjects/Shop/app/Resources/views');
        $instance->addPath('/home/ars/NetBeansProjects/Shop/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5ec240321da65c3ae385a7f6844b3a6e54796912');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/ars/NetBeansProjects/Shop/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/ars/NetBeansProjects/Shop/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/ars/NetBeansProjects/Shop/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/ars/NetBeansProjects/Shop/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/ars/NetBeansProjects/Shop/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/ars/NetBeansProjects/Shop/app/cache/dev',
            'kernel.logs_dir' => '/home/ars/NetBeansProjects/Shop/app/logs',
            'kernel.bundles' => array(
                ...
                'PrognozMagazineBundle' => 'Prognoz\\MagazineBundle\\PrognozMagazineBundle',
            ...
            'database_user' => 'magazine',
            'database_password' => 't4ograf8z7toi75y485oq758ao4',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '5ec240321da65c3ae385a7f6844b3a6e54796912',
            ...
            'debug.container.dump' => '/home/ars/NetBeansProjects/Shop/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '5ec240321da65c3ae385a7f6844b3a6e54796912',
            ...
            'session.save_path' => '/home/ars/NetBeansProjects/Shop/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/ars/NetBeansProjects/Shop/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home/ars/NetBeansProjects/Shop/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/ars/NetBeansProjects/Shop/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/ars/NetBeansProjects/Shop/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/ars/NetBeansProjects/Shop/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/ars/NetBeansProjects/Shop/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/ars/NetBeansProjects/Shop/app/../web',
            'assetic.write_to' => '/home/ars/NetBeansProjects/Shop/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/ars/NetBeansProjects/Shop/app/cache/dev/doctrine/orm/Proxies',
